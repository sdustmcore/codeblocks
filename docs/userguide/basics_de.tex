...
\hint{Wenn eine geänderte Datei geschlossen wird, geht die Änderungsinformation verloren, d.h. beim nächsten Öffnen werden keine Balken mehr angezeigt.}
