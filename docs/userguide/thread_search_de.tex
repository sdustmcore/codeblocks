...
\item[Delete previous results at search begin] Bei der Suche mit ThreadSearch und der Einstellung \samp{Tree View} werden die Suchergebnisse hierarchisch angezeigt, d.h.
\begin{itemize}
...
\hint{In der Anzeige der Suchergebnisse können auch einzelne oder alle Einträge über das Kontextmenü \menu{Delete item} bzw. \menu{Delete all items} gelöscht werden.}
\end{description}
